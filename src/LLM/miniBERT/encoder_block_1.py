...
# 1) Get post-LN input to Block 1
inp_pre = np.array(acts['bert.encoder.layer.0.output.LayerNorm'], dtype=float)  # [B, S, H]
ln0_w   = np.array(params['bert.encoder.layer.0.output.LayerNorm.weight'], dtype=float)
ln0_b   = np.array(params['bert.encoder.layer.0.output.LayerNorm.bias'],   dtype=float)

mu0  = inp_pre.mean(axis=-1, keepdims=True)
var0 = inp_pre.var(axis=-1, keepdims=True)
x    = (inp_pre - mu0) / np.sqrt(var0 + 1e-12) * ln0_w + ln0_b            # [B,S,H]

# 2) Q/K/V projections (matmul + bias add + logging)
Wq = np.array(params['bert.encoder.layer.1.attention.self.query.weight'], dtype=float)
Bq = np.array(params['bert.encoder.layer.1.attention.self.query.bias'],   dtype=float)
Wk = np.array(params['bert.encoder.layer.1.attention.self.key.weight'],   dtype=float)
Bk = np.array(params['bert.encoder.layer.1.attention.self.key.bias'],     dtype=float)
Wv = np.array(params['bert.encoder.layer.1.attention.self.value.weight'], dtype=float)
Bv = np.array(params['bert.encoder.layer.1.attention.self.value.bias'],   dtype=float)

Bsz, seq_len, hidden = x.shape

mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_0.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_0.txt")
...
# 4.1) qh @ kh^T
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_1.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_1.txt")
...
with open(os.path.join(DIR_NONLIN, "inv_sqrt_0_block1.txt"), "w") as nf:
...
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_2.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_2.txt")
...
mask_add_path = os.path.join(DIR_ADD, "encoder_block_1_add_3.txt")
mask_mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_3.txt")
...
exp_path = os.path.join(DIR_NONLIN, "exp_1.txt")
...
# Sum along last axis
sum_add_path = os.path.join(DIR_ADD, "encoder_block_1_add_4.txt")
sum_mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_4.txt")
...
# Reciprocal
div_path = os.path.join(DIR_DIV, "encoder_block_1_div_0.txt")
...
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_5.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_5.txt")
...
# Context: ctx = attn @ vh
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_6.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_6.txt")
...
Wout = np.array(params['bert.encoder.layer.1.attention.output.dense.weight'], dtype=float)
Bout = np.array(params['bert.encoder.layer.1.attention.output.dense.bias'],   dtype=float)

mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_7.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_7.txt")
...
# res1 = attn_out + x
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_8.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_8.txt")
...
# LN1 params of block1
ln1_w = np.array(params['bert.encoder.layer.1.attention.output.LayerNorm.weight'], dtype=float)
ln1_b = np.array(params['bert.encoder.layer.1.attention.output.LayerNorm.bias'],   dtype=float)

# m1 = mean(res1)
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_9.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_9.txt")
...
add_path_sub0 = os.path.join(DIR_ADD, "encoder_block_1_add_9a.txt")
...
# y2 = y1 * y1
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_10.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_10.txt")
...
# y3 = sum(y2)
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_11.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_11.txt")
...
# v1 = y3 * inv_H
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_12.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_12.txt")
...
# y4 = v1 + eps
eps = 1e-12
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_13.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_13.txt")
...
inv1_path = os.path.join(DIR_NONLIN, "inv_sqrt_1_block1.txt")
bound_lo, bound_hi = 0.001, 210.0
...
# y5 = y1 * inv_sqrt2
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_14.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_14.txt")
...
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_15.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_15.txt")
...
Wi = np.array(params['bert.encoder.layer.1.intermediate.dense.weight'], dtype=float)
Bi = np.array(params['bert.encoder.layer.1.intermediate.dense.bias'],   dtype=float)
Wo = np.array(params['bert.encoder.layer.1.output.dense.weight'],       dtype=float)
Bo = np.array(params['bert.encoder.layer.1.output.dense.bias'],         dtype=float)

# hidden = ln1_out @ Wi.T + Bi
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_16.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_16.txt")
...
# GELU inputs
gelu_in_path = os.path.join(DIR_NONLIN, "gelu_1.txt")
count_gelu_in = 0
bound = 5.0
...
# ffn = act @ Wo.T + Bo
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_17.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_17.txt")
...
# res2 = ffn + ln1_out
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_18.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_18.txt")
...
# LN2 params of block1
ln2_w = np.array(params['bert.encoder.layer.1.output.LayerNorm.weight'], dtype=float)
ln2_b = np.array(params['bert.encoder.layer.1.output.LayerNorm.bias'],   dtype=float)

# m2
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_19.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_19.txt")
...
add_path_sub1 = os.path.join(DIR_ADD, "encoder_block_1_add_19a.txt")
...
# t2 = t1 * t1
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_20.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_20.txt")
...
# t3 = sum(t2)
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_21.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_21.txt")
...
# v2 = t3 * inv_H
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_22.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_22.txt")
...
# t4 = v2 + eps
eps = 1e-12
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_23.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_23.txt")
...
# Save t4 (variance + eps for LN2) as inv_sqrt_2_block1.txt
t4_path = os.path.join(DIR_NONLIN, "inv_sqrt_2_block1.txt")
bound_lo, bound_hi = 0.001, 210.0
...
# t5 = t1 * inv_sqrt3
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_24.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_24.txt")
...
mul_path = os.path.join(DIR_MUL, "encoder_block_1_mul_25.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_1_add_25.txt")
...
# Final output
print("Encoder Block 1 output (post-LN) shape:", ln2_out.shape)
print(ln2_out)

# 9) Totals for operations (Block 1)
...
# Q/K/V tallies were stored in total_add / total_mul
add_total = globals().get("total_add", 0) + _sum_scalar_counts("add_count")
mul_total = globals().get("total_mul", 0) + _sum_scalar_counts("mul_count")
...
# inv_sqrt style calls (Hd scale is 1 scalar; y4 & t4 are arrays)
