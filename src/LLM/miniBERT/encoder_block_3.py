...
# 1) Get post-LN input to Block 3
inp_pre = np.array(acts['bert.encoder.layer.2.output.LayerNorm'], dtype=float)  # [B,S,H]
ln2_w_prev = np.array(params['bert.encoder.layer.2.output.LayerNorm.weight'], dtype=float)
ln2_b_prev = np.array(params['bert.encoder.layer.2.output.LayerNorm.bias'],   dtype=float)

mu_prev  = inp_pre.mean(axis=-1, keepdims=True)
var_prev = inp_pre.var(axis=-1, keepdims=True)
x = (inp_pre - mu_prev) / np.sqrt(var_prev + 1e-12) * ln2_w_prev + ln2_b_prev  # [B,S,H]

# 2) Q/K/V projections (matmul + bias add + logging)
Wq = np.array(params['bert.encoder.layer.3.attention.self.query.weight'], dtype=float)
Bq = np.array(params['bert.encoder.layer.3.attention.self.query.bias'],   dtype=float)
Wk = np.array(params['bert.encoder.layer.3.attention.self.key.weight'],   dtype=float)
Bk = np.array(params['bert.encoder.layer.3.attention.self.key.bias'],     dtype=float)
Wv = np.array(params['bert.encoder.layer.3.attention.self.value.weight'], dtype=float)
Bv = np.array(params['bert.encoder.layer.3.attention.self.value.bias'],   dtype=float)

Bsz, seq_len, hidden = x.shape

mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_0.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_0.txt")
...
# 4.1) qh @ kh^T
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_1.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_1.txt")
...
# 4.2) scale by 1/sqrt(Hd)  (save Hd too)
with open(os.path.join(DIR_NONLIN, "inv_sqrt_0_block3.txt"), "w") as nf:
...
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_2.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_2.txt")
...
mask_add_path = os.path.join(DIR_ADD, "encoder_block_3_add_3.txt")
mask_mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_3.txt")
...
exp_path = os.path.join(DIR_NONLIN, "exp_3.txt")
...
# Sum along last axis
sum_add_path = os.path.join(DIR_ADD, "encoder_block_3_add_4.txt")
sum_mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_4.txt")
...
# Reciprocal
div_path = os.path.join(DIR_DIV, "encoder_block_3_div_0.txt")
...
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_5.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_5.txt")
...
# Context: ctx = attn @ vh
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_6.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_6.txt")
...
Wout = np.array(params['bert.encoder.layer.3.attention.output.dense.weight'], dtype=float)
Bout = np.array(params['bert.encoder.layer.3.attention.output.dense.bias'],   dtype=float)

mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_7.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_7.txt")
...
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_8.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_8.txt")
...
# LN1 params (block3)
ln1_w = np.array(params['bert.encoder.layer.3.attention.output.LayerNorm.weight'], dtype=float)
ln1_b = np.array(params['bert.encoder.layer.3.attention.output.LayerNorm.bias'],   dtype=float)

# m1 = mean(res1)
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_9.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_9.txt")
...
add_path_sub0 = os.path.join(DIR_ADD, "encoder_block_3_add_9a.txt")
...
# y2 = y1 * y1
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_10.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_10.txt")
...
# y3 = sum(y2)
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_11.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_11.txt")
...
# v1 = y3 * inv_H
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_12.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_12.txt")
...
# y4 = v1 + eps
eps = 1e-12
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_13.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_13.txt")
...
# Save y4 as inv_sqrt_1_block3.txt
inv1_path = os.path.join(DIR_NONLIN, "inv_sqrt_1_block3.txt")
bound_lo, bound_hi = 0.001, 210.0
...
# y5 = y1 * inv_sqrt2
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_14.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_14.txt")
...
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_15.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_15.txt")
...
Wi = np.array(params['bert.encoder.layer.3.intermediate.dense.weight'], dtype=float)
Bi = np.array(params['bert.encoder.layer.3.intermediate.dense.bias'],   dtype=float)
Wo = np.array(params['bert.encoder.layer.3.output.dense.weight'],       dtype=float)
Bo = np.array(params['bert.encoder.layer.3.output.dense.bias'],         dtype=float)

# hidden = ln1_out @ Wi.T + Bi
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_16.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_16.txt")
...
# GELU inputs
gelu_in_path = os.path.join(DIR_NONLIN, "gelu_3.txt")
count_gelu_in = 0
bound = 5.0
...
# ffn = act @ Wo.T + Bo
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_17.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_17.txt")
...
# res2 = ffn + ln1_out
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_18.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_18.txt")
...
# LN2 params (block3)
ln2_w = np.array(params['bert.encoder.layer.3.output.LayerNorm.weight'], dtype=float)
ln2_b = np.array(params['bert.encoder.layer.3.output.LayerNorm.bias'],   dtype=float)

# m2
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_19.txt")
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_19.txt")
...
add_path_sub1 = os.path.join(DIR_ADD, "encoder_block_3_add_19a.txt")
...
# t2 = t1 * t1
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_20.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_20.txt")
...
# t3 = sum(t2)
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_21.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_21.txt")
...
# v2 = t3 * inv_H
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_22.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_22.txt")
...
# t4 = v2 + eps
eps = 1e-12
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_23.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_23.txt")
...
# Save t4 as inv_sqrt_2_block3.txt
t4_path = os.path.join(DIR_NONLIN, "inv_sqrt_2_block3.txt")
bound_lo, bound_hi = 0.001, 210.0
...
# t5 = t1 * inv_sqrt3
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_24.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_24.txt")
...
mul_path = os.path.join(DIR_MUL, "encoder_block_3_mul_25.txt")
add_path = os.path.join(DIR_ADD, "encoder_block_3_add_25.txt")
...
# Final output
print("Encoder Block 3 output (post-LN) shape:", ln2_out.shape)
print(ln2_out)

# 9) Totals for operations (Block 3)
