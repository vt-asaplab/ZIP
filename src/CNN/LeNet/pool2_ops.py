...
X = np.array(acts["pool2_in"], dtype=np.float64)  # [1,16,5,5]
...
print(f"[pool2] multiplications logged: {mul_count}")
print(f"[pool2] additions       logged: {add_count}")
